...
*Left: The upper-most sediment collected from Silver Lake, a 16-m deep subalpine lake in western Montana. The core shows a distinct layer of light-grey tephra deposited from the 1980 erruption of Mount St. Helens (Photo: P. Higuera, 2017). Right: Split sediment cores in the University of Montana's PaleoEcology and Fire Ecology lab. The demarcations at every 0.5 cm are where the cores were sliced for continuous sampling (Photo: Univ. of Montana, 2019).*
