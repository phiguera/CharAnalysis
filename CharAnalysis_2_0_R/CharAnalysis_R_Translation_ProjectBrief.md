...
| Dataset | Config | `threshFinalPos` max | diff |   |
|----|----|----|----|----|
...
*This project was planned with the assistance of Claude, an AI assistant by Anthropic. All code will be reviewed and validated by Philip Higuera ([philip.higuera\@umontana.edu](mailto:philip.higuera@umontana.edu){.email}) against Version 2.0 MATLAB reference outputs before being merged to the main branch.*
