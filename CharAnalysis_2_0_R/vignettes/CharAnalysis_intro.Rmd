---
title: "CharAnalysis: peak detection in high-resolution sediment-charcoal records"
...
output:
  rmarkdown::html_vignette:
    ...
    fig_height: 5
vignette: >
  %\VignetteIndexEntry{CharAnalysis: peak detection in high-resolution sediment-charcoal records}
...
***CharAnalysis*** is program for reconstructing local fire histories from high-resolution, continuously sampled lake-sediment charcoal records. It is designed specifically for macroscopic charcoal records with contiguous sampling at fine enough resolution to resolve individual fire events; it is *not* appropriate for low-resolution or discontinuously sampled records. The program formalises the logic of peak-detection as a reproducible, quantitative workflow.
